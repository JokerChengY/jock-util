...
//            chineseStr = chineseStr + "整";
    ...
    public static void main(String[] args) {
        String s= "250";
        double sd=Double.valueOf(s.toString());
        System.out.println(MoneyDigitToChinese(sd));
     ...
     * String转Double后返回结果
     */
    public static String MoneyDigitToChineseForString(String money) {
        if (StringUtils.isEmpty(money)){
            throw new  NullPointerException("money is null");
        }

        return MoneyDigitToChinese(Double.valueOf(money));
    }
}
